class linefollower:
    ...
    def follow_line(self):
        ...
        if sensor_data[0] == 1 and sensor_data[7] == 1:
            ...
            if total_step > 1:
                self.previous_right_steps = (right_step / total_step)
                self.previous_left_steps = (left_step / total_step)
            
            self.right_steps += self.previous_right_steps
            self.left_steps += self.previous_left_steps
